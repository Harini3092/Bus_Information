...
<div class="card-body" style="background-image: linear-gradient(#2144,pink);">
                        ...
                        <form role="form" method="post" action="stoptrans.php">
                            
                            <div class="form-group">
                              <input class="form-control" placeholder="id" name="LOCATION_ID">
                            </div>     
                            <div class="form-group">
                            ...
                            <button type="submit" value="submit" name="save" class="btn btn-default">Save Record</button>
